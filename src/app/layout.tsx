...
// Marketing site typography (see design handoff): Archivo for headings/UI/body,
// IBM Plex Mono for numeric/mono readouts.
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body
        className={`${dmSans.variable} ${jetbrainsMono.variable} ${instrumentSerif.variable} ${archivo.variable} ${ibmPlexMono.variable} antialiased`}
        style={{
